...
export const constantRoutes = [
	...
	{
		path: '/uqrCode',
		component: (resolve) => require(['@/pages/uqrCode'], resolve),
		hidden: true
	},
	{
		path: '/apply',
	...
	{
		path: '/mabnormalcheck', // 干部异常待签核界面
		component: (resolve) => require(['@/pages/system/mabnormalcheck'], resolve),
		hidden: true
	},
	{
		path: '/mabnormalchecks', // 干部异常待签核界面
		component: (resolve) => require(['@/pages/system/mabnormalchecks'], resolve),
		hidden: true
	},
	{
	...
	{
		path: '/abnormalcheck', // 异常签核界面
		component: (resolve) => require(['@/pages/abnormalcheck'], resolve),
		hidden: true
	},
	{
		path: '/abnormalchecks', // 异常签核界面
		component: (resolve) => require(['@/pages/abnormalchecks'], resolve),
		hidden: true
	},
	{
...
export default new Router({
	...
	base: '/releaseGood/', //ReleaseSystem/接口也是写在PubmiddleGround里面，只是前端用uniapp开发
	scrollBehavior: () => ({
		y: 0
	}),
